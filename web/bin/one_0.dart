...
final MetaElement description =
    querySelector('meta[name="description"]') as MetaElement;
final MetaElement keywords =
    querySelector('meta[name="keywords"]') as MetaElement;
...
Future<void> makeRequest() async {
  ...
  final path = (port != '')
      ? '$protocol//$hostname:$port/api/$uriString'
...
void fillPage(List<dynamic> jsonData) {
  ...
  cntnt?.text = itemJsonData['content'];
}
